...
$('#first_name,#surname').bind('keypress', testInput); /* Disable disgits in text fields*/
...
$(function() {
    ...
    /* Reports Page */
    $("#from_date").datepicker({ changeMonth: !0, changeYear: !0, autoclose: 1, dateFormat: "dd-mm-yy", maxDate: "+D", yearRange: "-130:+0", showAnim: "slide", beforeShow: function(e, t) { inputField = $(e), inputField.parents(".ui-dialog").length > 0 && (inputField.parent().append($("#ui-datepicker-div")), $("#ui-datepicker-div").addClass("datepicker-modal"), $("#ui-datepicker-div").hide()) }, onClose: function(e, t) { $(this).datepicker("option", "dateFormat", "dd-mm-yy") } }).on("change", function(e) {
        var t = $(this).datepicker("getDate"),
            a = new Date;
        a.setDate(a.getDate() + 1), a.setHours(0, 0, 0, 0), t > a && $(this).datepicker("setDate", a), t && (t.setDate(t.getDate() + 1), $("#to_date").val(""), $("#to_date").datepicker("option", "minDate", t))
    }).keyup(function(e) { $("#to_date").val(""), $("#to_date").datepicker("option", "minDate", null) }), $("#to_date").datepicker({
        changeMonth: !0,
        changeYear: !0,
        autoclose: 1,
        dateFormat: "dd-mm-yy",
        ...
        beforeShow: function(e, t) {
            ...
            null != a && (a.setDate(a.getDate() + 1), $(this).datepicker("option", "minDate", a)), inputField = $(e), inputField.parents(".ui-dialog").length > 0 && (inputField.parent().append($("#ui-datepicker-div")), $("#ui-datepicker-div").addClass("datepicker-modal"), $("#ui-datepicker-div").hide())
        },
        onClose: function(e, t) { $(this).datepicker("option", "dateFormat", "dd-mm-yy") }
    }).on("change", function(e) {
        var t = $(this).datepicker("getDate"),
            a = new Date;
        a.setDate(a.getDate() + 1), a.setHours(0, 0, 0, 0), t > a && $(this).datepicker("setDate", a)
    });
